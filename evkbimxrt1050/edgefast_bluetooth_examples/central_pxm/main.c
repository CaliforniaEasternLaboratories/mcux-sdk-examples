...
int main(void)
{
    ...
    if (xTaskCreate(central_pxm_task, "central_pxm_task", configMINIMAL_STACK_SIZE * 8, NULL, tskIDLE_PRIORITY + 1, NULL) != pdPASS)
    {
        PRINTF("central pxm task creation failed!\r\n");
        while (1)
            ;
    }
